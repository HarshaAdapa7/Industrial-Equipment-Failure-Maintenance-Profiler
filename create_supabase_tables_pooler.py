...
print("Connecting to Supabase Pooler endpoint...")
conn = psycopg2.connect(conn_str)
conn.autocommit = True
cursor = conn.cursor()
cursor.execute(sql_script)
print("SUCCESS! ALL TABLES CREATED IN SUPABASE CLOUD DATABASE!")

cursor.execute("SELECT table_name FROM information_schema.tables WHERE table_schema = 'public';")
tables = cursor.fetchall()
print("Created Tables in Supabase public schema:", [t[0] for t in tables])
