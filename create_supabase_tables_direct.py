...
# Test Supabase connection strings (direct and poolers)
connection_strings = [
    "postgresql://postgres:Harsha%409515445632@db.frfkburreisufcdkqpji.supabase.co:5432/postgres?sslmode=require",
    "postgresql://postgres.frfkburreisufcdkqpji:Harsha%409515445632@aws-0-ap-south-1.pooler.supabase.com:6543/postgres?sslmode=require",
    "postgresql://postgres.frfkburreisufcdkqpji:Harsha%409515445632@aws-0-us-east-1.pooler.supabase.com:6543/postgres?sslmode=require",
    "postgresql://postgres.frfkburreisufcdkqpji:Harsha%409515445632@aws-0-eu-central-1.pooler.supabase.com:6543/postgres?sslmode=require"
]
...
def attempt_table_creation():
    for conn_str in connection_strings:
        try:
            ...
            print("SUCCESS! Tables created in Supabase PostgreSQL cloud database!")
            cursor.close()
            conn.close()
            return True
        except Exception as e:
            print(f"Failed with {conn_str.split('@')[-1]}: {e}")
    return False

if __name__ == '__main__':
    attempt_table_creation()
